...
Route::prefix('order')->name('order.')->group(function () {
    ...
    Route::post('checkout/finalize-free', [CheckoutPaymentController::class, 'finalizeFree'])->middleware('throttle:10,1')->name('checkout.finalize-free');
    ...
    Route::post('confirm/{order}/payment/initiate', [PaymentController::class, 'initiate'])->middleware('throttle:10,1')->name('payment.initiate');
    Route::post('confirm/{order}/payment/verify', [PaymentController::class, 'verify'])->middleware('throttle:10,1')->name('payment.verify');
...
Route::middleware(['ensure.admin.https', 'auth:web', 'verified', 'role:Admin|Kitchen'])->group(function () {
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('settings/test-razorpay', [SettingsController::class, 'testRazorpay'])->name('settings.test-razorpay');

...
<div class="mb-8 grid gap-4 sm:grid-cols-3">
    <div data-highlight-target="kitchen_today" class="flex items-center gap-4 rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-5 shadow-sm {{ in_array('kitchen_today', ($unreadHighlightTargets ?? collect())->toArray(), true) ? 'notification-highlight' : '' }}">
    ...
    <div data-highlight-target="kitchen_upcoming" class="flex items-center gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm {{ in_array('kitchen_upcoming', ($unreadHighlightTargets ?? collect())->toArray(), true) ? 'notification-highlight' : '' }}">

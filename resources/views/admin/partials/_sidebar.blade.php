<aside
    id="admin-sidebar"
    class="admin-sidebar shrink-0 border-r border-gray-200 bg-white"
    data-admin-sidebar
...
>
    <div class="shrink-0 border-b border-gray-100 bg-gray-50/50 px-5 py-5">
        <div class="flex items-start justify-between gap-3">
            ...
            <button
                type="button"
                class="admin-sidebar__close lg:hidden inline-flex shrink-0 items-center justify-center rounded-lg p-2 text-gray-500 transition hover:bg-gray-100 hover:text-gray-700"
    ...
    <nav class="admin-sidebar__nav space-y-0.5 px-3 py-4">
        ...
        @endcan
        @can('coupons.view')
        <a href="{{ route('admin.coupons.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition duration-200 {{ request()->routeIs('admin.coupons.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>
            {{ __('Coupons') }}
        </a>
        @endcan

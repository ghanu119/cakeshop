<div class="space-y-4" data-order-contact-section>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div class="md:col-span-2">
            ...
            <input type="email" name="guest_email" id="guest_email" wire:model="guest_email" class="block w-full rounded-lg border-stone-300 shadow-sm focus:border-amber-500 focus:ring-amber-500" required />

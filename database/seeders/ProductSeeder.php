    ...
    public function run(): void
    {
        ...
        $items = [
            [
                ...
                'sku' => 'CAKE-CHOC-TRUFFLE',
                'earliest_delivery_label' => '4–5 hours',
                'min_hours_before_delivery' => 4,
                'show_whatsapp_customize_help' => true,
            ...
            [
                ...
                'sku' => 'CAKE-RED-VELVET',
                'earliest_delivery_label' => '1–2 days',
            ...
            [
                ...
                'earliest_delivery_label' => '1-2 Hours',
            ...
            [
                ...
                'sku' => 'CAKE-DRY-FRUIT',
                'earliest_delivery_label' => '2–3 days',
                'min_hours_before_delivery' => 48,
        ...
        foreach ($items as $item) {
            ...
            $product = Product::updateOrCreate(
                ...
                [
                    ...
                    'sku' => $item['sku'] ?? strtoupper(str_replace('-', '_', $item['slug'])),
                    'earliest_delivery_label' => $item['earliest_delivery_label'] ?? null,
                    'min_hours_before_delivery' => $item['min_hours_before_delivery'] ?? null,
                    'show_whatsapp_customize_help' => $item['show_whatsapp_customize_help'] ?? false,
                    'price' => $startingPrice,
                    'status' => 'active',
